...
export const BANGKOK_LAYERS: LayerSpec[] = [
  ...
  { id: 'fires-gistda',    label: 'FIRES · GISTDA 2023',  description: 'VIIRS hotspots from GISTDA. Service last refreshed Apr 2023 — historical 2023 fire-season snapshot, not live.', source: 'GISTDA', defaultOn: false, status: 'live', category: 'fire' },
  ...
  { id: 'floods',          label: 'FLOODS · LIVE',   description: 'GISTDA daily flood-extent polygons (not the multi-year frequency layer). Empty means no daily polygons, not ALL CLEAR.',       source: 'GISTDA',     defaultOn: false, status: 'live',    category: 'water' },
  ...
  { id: 'gtfs-transit-live', label: 'SIMULATED TRANSIT (MOCK)', description: 'Mock GTFS-Realtime showing simulated train movements along the BTS Sukhumvit line. Not a live operator feed.', source: 'GTFS', defaultOn: false, status: 'pending', category: 'transit' },
